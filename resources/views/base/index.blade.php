                    ...
                    <div class="hover-scroll-overlay-y my-2 my-lg-5 pe-lg-n1" id="kt_aside_menu_wrapper"
                        ...
                        <div class="menu menu-column menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold"
                            ...
                            <div class="menu-item py-2">
                                <a class="menu-link menu-center" href="../../demo6/dist/index.html"
                            ...
                            <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start"
                                ...
                                <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                                    ...
                                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                        data-kt-menu-placement="right-start" data-kt-menu-flip="false"
                                    ...
                                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="../../demo6/dist/authentication/email/verify-email.html"
                                                    target="blank">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="../../demo6/dist/authentication/email/password-reset.html"
                                                    target="blank">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                            ...
                            <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start"
                                ...
                                <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link"
                                            href="../../demo6/dist/apps/customers/getting-started.html">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                            ...
                            <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start"
                                ...
                                <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link active" href="../../demo6/dist/pages/company/pricing.html">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                            ...
                            <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start"
                                ...
                                <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="../../demo6/dist/documentation/base/utilities.html"
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="../../demo6/dist/documentation/getting-started.html"
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link"
                                            href="https://preview.keenthemes.com/metronic8/demo6/layout-builder.html"
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link"
                                            href="../../demo6/dist/documentation/getting-started/changelog.html">
                                            <span class="menu-icon">
                                    ...
                                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
                                        ...
                                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                                            ...
                                            <div
                                                ...
                                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                    data-kt-menu-placement="right-start"
                                                    class="menu-item here show menu-lg-down-accordion">
                                                    <span class="menu-link py-3">
                                                        <span class="menu-icon">
                                                            <i class="bi bi-archive fs-3"></i>
                                                        </span>
                                                    ...
                                                    <div
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/profile/overview.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Overview</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/profile/projects.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/profile/campaigns.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/profile/documents.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/profile/connections.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/profile/activity.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/projects/list.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/projects/project.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/projects/targets.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/projects/budget.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/projects/users.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Users</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/projects/files.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/projects/activity.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Activity</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/projects/settings.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Settings</span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/wizards/horizontal.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/wizards/vertical.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/search/horizontal.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Horizontal</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/search/vertical.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Vertical</span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/blog/home.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/blog/post.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/company/about.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">About Us</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link active py-3"
                                                                        href="../../demo6/dist/pages/company/pricing.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Pricing</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/company/contact.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Contact Us</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/company/team.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Our Team</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/company/licenses.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Licenses</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/company/sitemap.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Sitemap</span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/careers/list.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/careers/apply.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/faq/classic.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/pages/faq/extended.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Extended</span>
                                                ...
                                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/account/statements.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Statements</span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/account/referrals.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Referrals</span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/account/api-keys.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">API Keys</span>
                                                    ...
                                                    <div
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/authentication/flows/aside/sign-in.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Sign-in</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/authentication/flows/aside/sign-up.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Sign-up</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/authentication/flows/aside/two-steps.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Two-steps</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/authentication/flows/aside/password-reset.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Password Reset</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/authentication/flows/aside/new-password.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">New Password</span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/authentication/flows/dark/sign-in.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Sign-in</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/authentication/flows/dark/sign-up.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Sign-up</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/authentication/flows/dark/two-steps.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Two-steps</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/authentication/flows/dark/password-reset.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Password Reset</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/authentication/flows/dark/new-password.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">New Password</span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/authentication/general/deactivation.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/authentication/email/invitation.html"
                                                                        target="blank">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                    ...
                                                    <div
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/modals/general/invite-friends.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/modals/general/view-users.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/modals/general/upgrade-plan.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/modals/general/share-earn.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/modals/forms/new-target.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/modals/forms/new-card.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/modals/forms/new-address.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/modals/forms/create-api-key.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/modals/wizards/two-factor-authentication.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/modals/wizards/create-app.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/modals/wizards/create-account.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/modals/wizards/create-project.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/modals/wizards/offer-a-deal.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/modals/search/users.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                        <span class="menu-title">Users</span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/modals/search/select-location.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                ...
                                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/widgets/lists.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/widgets/statistics.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/widgets/charts.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/widgets/mixed.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/widgets/tables.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/widgets/feeds.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                            ...
                                            <div
                                                    ...
                                                    <div
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/apps/user-management/users/list.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/apps/user-management/roles/list.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/apps/user-management/permissions.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                    ...
                                                    <div
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/apps/invoices/view/invoice-1.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/apps/invoices/view/invoice-2.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/apps/invoices/create.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                ...
                                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/apps/support-center/overview.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Overview</span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/apps/support-center/tickets/list.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/apps/support-center/tickets/view.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                        ...
                                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/apps/support-center/tutorials/list.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                                ...
                                                                <div class="menu-item">
                                                                    <a class="menu-link py-3"
                                                                        href="../../demo6/dist/apps/support-center/tutorials/post.html">
                                                                        <span class="menu-bullet">
                                                                            <span class="bullet bullet-dot"></span>
                                                                        </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/apps/support-center/faq.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">FAQ</span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/apps/support-center/licenses.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Licenses</span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/apps/support-center/contact.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Contact Us</span>
                                                ...
                                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/apps/customers/list.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Customer Listing</span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/apps/customers/view.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Customer Details</span>
                                                ...
                                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/apps/subscriptions/getting-started.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Getting Started</span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/apps/subscriptions/list.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/apps/subscriptions/add.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/apps/subscriptions/view.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                ...
                                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/apps/chat/private.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Private Chat</span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/apps/chat/group.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Group Chat</span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/apps/chat/drawer.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Drawer Chat</span>
                                                ...
                                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/apps/file-manager/folders.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/apps/file-manager/files.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Files</span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/apps/file-manager/blank.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                        ...
                                                        <div class="menu-item">
                                                            <a class="menu-link py-3"
                                                                href="../../demo6/dist/apps/file-manager/settings.html">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title">Settings</span>
                                        ...
                                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="../../demo6/dist/documentation/base/utilities.html"
                                                        title="Check out over 200 in-house components, plugins and ready for use solutions"
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3"
                                                        href="../../demo6/dist/documentation/getting-started.html"
...
-->
                                                ...
                                                <form data-kt-search-element="advanced-options-form"
                                                    ...
                                                    <div class="d-flex justify-content-end">
                                                        ...
                                                        <a href="../../demo6/dist/pages/search/horizontal.html"
                                    ...
                                    <div class="d-flex align-items-center ms-1 ms-lg-3">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px"
                                            ...
                                            <div class="row g-0">
                                                <!--begin:Item-->
                                                <div class="col-6">
                                                    <a href="../../demo6/dist/pages/projects/budget.html"
                                                ...
                                                <!--begin:Item-->
                                                <div class="col-6">
                                                    <a href="../../demo6/dist/pages/projects/settings.html"
                                                ...
                                                <!--begin:Item-->
                                                <div class="col-6">
                                                    <a href="../../demo6/dist/pages/projects/list.html"
                                                ...
                                                <!--begin:Item-->
                                                <div class="col-6">
                                                    <a href="../../demo6/dist/pages/projects/users.html"
